...
X_scaled, y_scaled = X_scaled.reshape(x_samples, x_features1, x_features2), y_scaled.reshape(y_samples, y_features1, y_features2)
...
MSE_normalized_hygro = model.evaluate(X_test, y_test)
print('RMSE of normalized hygro:', numpy.sqrt(MSE_normalized_hygro))
